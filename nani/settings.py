...
DATABASES = {
    ...
    'partner': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('PARTNER_DB_NAME'),
...
DATABASE_ROUTERS = ['vk.router.AuthRouter']
...
# Only add STATICFILES_DIRS if you have additional static files
# outside of your apps' static folders
